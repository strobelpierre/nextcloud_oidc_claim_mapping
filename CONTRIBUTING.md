...
# Contributing to OIDC Claim Mapping

Thanks for your interest in contributing! This guide will help you get started.

## Reporting bugs

Open a [bug report](https://github.com/strobelpierre/nextcloud_oidc_claim_mapping/issues/new?template=bug_report.md) and include:
...
Open a [feature request](https://github.com/strobelpierre/nextcloud_oidc_claim_mapping/issues/new?template=feature_request.md) describing your use case and proposed solution.
